            ...
            if (el.is(':checkbox')) {
                ...
                var selectboxOutput = function() {
                    ...
                    function doSelect() {
                        ...
                        var dataText = option.attr('data-text');
                        ...
                        if (option.first().text() === '' && option.first().is(':selected')) {
                            ...
                            var dataText = optionSelected.attr('data-text');
                            if(dataText) {
                                divText.text(dataText);
                            } else {
                        ...
                        li.filter(':not(.disabled):not(.optgroup)').click(function() {
                            ...
                            if (!t.is('.selected')) {
                                ...
                                selectedText = liText;
                                var dataText = option.filter(':selected').attr('data-text');
                        ...
                        // изменение селекта
                        el.on('change.styler', function() {
                            var selOpt = option.filter(':selected');
                            var dataText = selOpt.attr('data-text');
                            if(dataText != '' && dataText != 'undefined')
                                divText.text(dataText);
                            else
                                divText.text(selOpt.text()).removeClass('placeholder');
