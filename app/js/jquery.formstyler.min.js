                ...
                var f = function () {
                    ...
                    function n() {
                        for (var e = 0; e < f.length; e++) {
                            var t = f.eq(e), s = "", i = "", o = "", a = "", d = "", n = "", r = "", c = "", u = "", p = "disabled", v = "selected sel disabled";
                    ...
                    function r() {
                        var a = new t, r = "", c = i.data("placeholder"), u = i.data("search"), p = i.data("search-limit"), v = i.data("search-not-found"), m = i.data("search-placeholder"), g = i.data("z-index"), b = i.data("smart-positioning");
                        ...
                        var D = y.outerHeight(!0), I = k.parent().outerHeight(!0), H = _.css("max-height"), z = j.filter(".selected");
                        ...
                        C.click(function () {
                            if (e("div.jq-selectbox").filter(".opened").length && l.onSelectClosed.call(e("div.jq-selectbox").filter(".opened")), i.focus(), !o) {
                                var t = e(window), s = j.data("li-height"), a = y.offset().top, n = t.height() - D - (a - t.scrollTop()), r = i.data("visible-options");
                                ...
                                var u = function () {
                                    ...
                                    q.height("auto").css({top: "auto", bottom: K});
                                    var e = function () {
                    ...
                    function c() {
                        ...
                        }), a = e("li", l).attr("unselectable", "on"), r = i.attr("size"), c = o.outerHeight(), u = a.outerHeight();
